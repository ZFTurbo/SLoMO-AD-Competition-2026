    ...
    for video_id in videos_to_proc:
        ...
        for c in chars:
            ...
            if not os.path.exists(im_path):
                # print(im_path)
                # print("No actor image {}...".format(c['id']))
                continue
        ...
        total_frames = len(vr)  # Общее количество кадров в видео
        original_fps = vr.get_avg_fps()  # Исходный FPS видео
        video_duration = total_frames / original_fps  # Длительность в секундах
